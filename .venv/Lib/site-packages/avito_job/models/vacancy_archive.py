...
class VacancyArchive(BaseModel):
    ...
    VacancyArchive
    """ # noqa: E501
    employee_id: Optional[StrictInt] = Field(default=None, description="employee_id - Идентификатор сотрудника на Авито. Сотрудник может останавливать только закрепленные за ним вакансии в Avito Pro. Сотрудник должен быть в активен. ")
