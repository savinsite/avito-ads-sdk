...
class StoppingForbiddenError(BaseModel):
    """
    StoppingForbiddenError
    """ # noqa: E501
    error: Optional[StoppingForbiddenErrorError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": StoppingForbiddenErrorError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
