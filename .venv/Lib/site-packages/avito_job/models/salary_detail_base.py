...
class SalaryDetailBase(BaseModel):
    ...
    Оклад
    """ # noqa: E501
    bonus: Optional[StrictStr] = Field(default=None, description="Премия. Не более 70 символов.")
    range: Optional[SalaryBaseRange] = None
    __properties: ClassVar[List[str]] = ["bonus", "range"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bonus": obj.get("bonus"),
            "range": SalaryBaseRange.from_dict(obj["range"]) if obj.get("range") is not None else None
        })
        return _obj
