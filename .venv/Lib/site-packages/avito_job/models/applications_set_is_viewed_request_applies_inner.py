...
class ApplicationsSetIsViewedRequestAppliesInner(BaseModel):
    """
    ApplicationsSetIsViewedRequestAppliesInner
    """ # noqa: E501
    id: StrictStr = Field(description="Идентификатор отклика")
    is_viewed: StrictBool = Field(description="Фильтр откликов по статусу просмотренности")
    __properties: ClassVar[List[str]] = ["id", "is_viewed"]
