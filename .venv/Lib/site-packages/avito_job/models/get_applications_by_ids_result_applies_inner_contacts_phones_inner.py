...
class GetApplicationsByIdsResultAppliesInnerContactsPhonesInner(BaseModel):
    """
    GetApplicationsByIdsResultAppliesInnerContactsPhonesInner
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Статус получения контакта от соискателя")
    value: Optional[StrictStr] = Field(default=None, description="Телефон соискателя")
