...
class BadRequestShort(BaseModel):
    """
    BadRequestShort
    """ # noqa: E501
    error: Optional[BadRequestShortError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": BadRequestShortError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
