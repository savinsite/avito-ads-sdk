...
class CreationForbiddenError(BaseModel):
    """
    CreationForbiddenError
    """ # noqa: E501
    error: Optional[CreationForbiddenErrorError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": CreationForbiddenErrorError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
