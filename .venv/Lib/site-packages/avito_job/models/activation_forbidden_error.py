...
class ActivationForbiddenError(BaseModel):
    """
    ActivationForbiddenError
    """ # noqa: E501
    error: Optional[ActivationForbiddenErrorError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": ActivationForbiddenErrorError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
