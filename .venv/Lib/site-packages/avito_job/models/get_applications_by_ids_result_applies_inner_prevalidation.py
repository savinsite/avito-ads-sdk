...
class GetApplicationsByIdsResultAppliesInnerPrevalidation(BaseModel):
    """
    Статус и результат превалидации кандидата
    """ # noqa: E501
    status: Optional[StrictStr] = None
    summary: Optional[List[Optional[PrevalidationAnswer]]] = Field(default=None, description="Выжимка превалидации. Массив ответов на вопросы")
    __properties: ClassVar[List[str]] = ["status", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "summary": [PrevalidationAnswer.from_dict(_item) for _item in obj["summary"]] if obj.get("summary") is not None else None
        })
        return _obj
