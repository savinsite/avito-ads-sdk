...
class WebhooksSubscriptionResultList(BaseModel):
    """
    WebhooksSubscriptionResultList
    """ # noqa: E501
    webhooks: List[WebhookSubscribeRequestBody] = Field(description="список вебхуков")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "webhooks": [WebhookSubscribeRequestBody.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None
        })
        return _obj
