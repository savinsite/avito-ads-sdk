...
class SearchVacancy403Response(BaseModel):
    """
    SearchVacancy403Response
    """ # noqa: E501
    error: Optional[SearchVacancy403ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": SearchVacancy403ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
