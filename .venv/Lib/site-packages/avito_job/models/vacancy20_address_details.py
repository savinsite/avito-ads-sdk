...
class Vacancy20AddressDetails(BaseModel):
    """
    Детали адреса вакансии
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="Полный адрес")
    city: Optional[StrictStr] = Field(default=None, description="Город")
    coordinates: Optional[Vacancy20AddressDetailsCoordinates] = None
    province: Optional[StrictStr] = Field(default=None, description="Область, например \"Новосибирская область\" или \"Санкт-Петербург\" для больших городов")
    __properties: ClassVar[List[str]] = ["address", "city", "coordinates", "province"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "city": obj.get("city"),
            "coordinates": Vacancy20AddressDetailsCoordinates.from_dict(obj["coordinates"]) if obj.get("coordinates") is not None else None,
