...
class AnalyticsResponseResultGroupingsInner(BaseModel):
    """
    AnalyticsResponseResultGroupingsInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    metrics: Optional[List[AnalyticsResponseResultGroupingsInnerMetricsInner]] = None
    type: Optional[Groupings] = None
    __properties: ClassVar[List[str]] = ["id", "metrics", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "metrics": [AnalyticsResponseResultGroupingsInnerMetricsInner.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
            "type": obj.get("type")
        })
        return _obj
