...
class VasAmountAvito(BaseModel):
    """
    VasAmountAvito
    """ # noqa: E501
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Сумма списания за применение услуги или пакета")
