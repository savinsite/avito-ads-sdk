...
class ItemsInfoWithCategoryAvitoMeta(BaseModel):
    """
    ItemsInfoWithCategoryAvitoMeta
    """ # noqa: E501
    page: Optional[StrictInt] = Field(default=None, description="Номер страницы")
    per_page: Optional[StrictInt] = Field(default=None, description="Количество записей на странице")
    __properties: ClassVar[List[str]] = ["page", "per_page"]
