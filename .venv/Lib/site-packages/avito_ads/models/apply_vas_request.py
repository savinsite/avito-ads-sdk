...
class ApplyVasRequest(BaseModel):
    """
    ApplyVasRequest
    """ # noqa: E501
    slugs: List[StrictStr] = Field(description="Список идентификаторов услуг")
    stickers: Optional[List[StrictInt]] = Field(default=None, description="Список значков")
    __properties: ClassVar[List[str]] = ["slugs", "stickers"]
