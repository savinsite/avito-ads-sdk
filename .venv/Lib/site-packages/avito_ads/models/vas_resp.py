...
class VasResp(BaseModel):
    """
    Информация об услугах и пакетах дополнительных услуг для переданного списка объявлений
    """ # noqa: E501
    price: StrictInt = Field(description="Цена со скидкой")
    price_old: StrictInt = Field(description="Цена до применения скидки", alias="priceOld")
    slug: StrictStr = Field(description="Идентификатор услуги или пакета услуг")
    __properties: ClassVar[List[str]] = ["price", "priceOld", "slug"]
