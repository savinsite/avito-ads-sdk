...
class ApplyVas500Response(BaseModel):
    """
    ApplyVas500Response
    """ # noqa: E501
    code: StrictInt
    ...
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set([1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010, 1011]):
            raise ValueError("must be one of enum values (1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010, 1011)")
        return value
