...
class DefaultApi:
    ...
    def update_price(
        ...
        update_price_request: Annotated[Optional[UpdatePriceRequest], Field(description="Набор параметров в теле запроса.")] = None,
        ...
        :type item_id: int
        :param update_price_request: Набор параметров в теле запроса.
    ...
    def update_price_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdatePriceResponse]:
        """Обновление цены объявления 
    ...
    def _update_price_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/core/v1/items/{item_id}/update_price',
