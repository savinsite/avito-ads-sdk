...
class ChatUsersInnerPublicUserProfileAvatar(BaseModel):
    """
    Фотография пользователя (аватар)
    """ # noqa: E501
    default: Optional[StrictStr] = None
    images: Optional[ChatUsersInnerPublicUserProfileAvatarImages] = None
    __properties: ClassVar[List[str]] = ["default", "images"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "images": ChatUsersInnerPublicUserProfileAvatarImages.from_dict(obj["images"]) if obj.get("images") is not None else None
        })
        return _obj
