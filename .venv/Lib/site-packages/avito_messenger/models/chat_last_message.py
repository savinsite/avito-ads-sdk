...
class ChatLastMessage(BaseModel):
    ...
    ChatLastMessage
    """ # noqa: E501
    author_id: Optional[StrictInt] = Field(default=None, description="Ссылка на профиль пользователя в Авито")
    content: Optional[MessageContent] = None
    created: Optional[StrictInt] = Field(default=None, description="Unix-timestamp времени отправки сообщения")
    direction: Optional[StrictStr] = Field(default=None, description="\"in\" для входящих сообщений, \"out\" для исходящих")
    id: Optional[StrictStr] = Field(default=None, description="Уникальный идентификатор сообщения")
    type: Optional[StrictStr] = Field(default=None, description="Тип контента в сообщений")
