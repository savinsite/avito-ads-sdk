...
class GetSubscriptions200ResponseSubscriptionsInner(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr
    version: StrictStr = Field(description="Версия метода, через который вебхук добавлен. Влияет на формат получаемых данных")
    __properties: ClassVar[List[str]] = ["url", "version"]
