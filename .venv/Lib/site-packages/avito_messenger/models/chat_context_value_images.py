...
class ChatContextValueImages(BaseModel):
    """
    Изображения с карточки объявления
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Число изображений")
    main: Optional[ChatContextValueImagesMain] = None
    __properties: ClassVar[List[str]] = ["count", "main"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "main": ChatContextValueImagesMain.from_dict(obj["main"]) if obj.get("main") is not None else None
        })
        return _obj
