...
class ChatUsersInnerPublicUserProfile(BaseModel):
    """
    ChatUsersInnerPublicUserProfile
    """ # noqa: E501
    avatar: Optional[ChatUsersInnerPublicUserProfileAvatar] = None
    item_id: Optional[StrictInt] = Field(default=None, description="ID объявления, выложенного пользователем")
    url: Optional[StrictStr] = Field(default=None, description="Ссылка на профиль пользователя в Авито")
    user_id: Optional[StrictInt] = Field(default=None, description="Уникальный ID пользователя. Обратите внимание на хэширование")
    __properties: ClassVar[List[str]] = ["avatar", "item_id", "url", "user_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "avatar": ChatUsersInnerPublicUserProfileAvatar.from_dict(obj["avatar"]) if obj.get("avatar") is not None else None,
