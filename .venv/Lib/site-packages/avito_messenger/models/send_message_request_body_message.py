...
class SendMessageRequestBodyMessage(BaseModel):
    """
    SendMessageRequestBodyMessage
    """ # noqa: E501
    text: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(default=None, description="Текст сообщения (максимум 1000 символов)")
