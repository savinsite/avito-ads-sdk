...
class MessageContentItem(BaseModel):
    ...
    item_url: Optional[StrictStr] = None
    price_string: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["image_url", "item_url", "price_string", "title"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if price_string (nullable) is None
        # and model_fields_set contains the field
        if self.price_string is None and "price_string" in self.model_fields_set:
            _dict['price_string'] = None
