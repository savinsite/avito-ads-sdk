...
class ChatContextValueImagesMain(BaseModel):
    """
    ChatContextValueImagesMain
    """ # noqa: E501
    var_140x105: Optional[StrictStr] = Field(default=None, description="Изображение в формате 140х105", alias="140x105")
    __properties: ClassVar[List[str]] = ["140x105"]
