...
from avito_messenger.configuration import Configuration
from avito_messenger.api_response import ApiResponse, T as ApiResponseT
import avito_messenger.models
from avito_messenger import rest
from avito_messenger.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(avito_messenger.models, klass)
