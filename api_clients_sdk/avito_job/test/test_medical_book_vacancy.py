...
class TestMedicalBookVacancy(unittest.TestCase):
    """MedicalBookVacancy unit test stubs"""
    ...
    def testMedicalBookVacancy(self):
        """Test MedicalBookVacancy"""
        # inst = MedicalBookVacancy()
