...
class TestItemNotFoundError(unittest.TestCase):
    """ItemNotFoundError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemNotFoundError:
        """Test ItemNotFoundError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemNotFoundError`
        """
        model = ItemNotFoundError()
        if include_optional:
            return ItemNotFoundError(
                error = avito_job.models.item_not_found_error_error.ItemNotFoundError_error(
                    type = 'vacancies', 
    ...
    def testItemNotFoundError(self):
        """Test ItemNotFoundError"""
