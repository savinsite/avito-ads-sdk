...
class TestVacancyUpdate(unittest.TestCase):
    """VacancyUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VacancyUpdate:
        """Test VacancyUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VacancyUpdate`
        """
        model = VacancyUpdate()
        if include_optional:
            return VacancyUpdate(
                ...
                name = '',
                payout_frequency = avito_job.models.vacancy_update_payout_frequency.VacancyUpdate_payout_frequency(
                    id = 'dailyPay', ),
                profession = 56,
                ...
                salary_detail = avito_job.models.salary_detail.SalaryDetail(
                    ...
                    paid_period = '["month"]', 
                    taxes = '["gross"]', ),
                salary_range = avito_job.models.vacancy_update_salary_range.VacancyUpdate_salary_range(
                    from = 30000, 
                    to = 60000, ),
                shifts = [
                    56
