...
class TestAgeCriteria(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AgeCriteria:
        """Test AgeCriteria
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgeCriteria`
        """
        model = AgeCriteria()
        if include_optional:
            return AgeCriteria(
