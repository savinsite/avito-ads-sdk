...
class TestGetApplicationsByIdsResult(unittest.TestCase):
    """GetApplicationsByIdsResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetApplicationsByIdsResult:
        """Test GetApplicationsByIdsResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetApplicationsByIdsResult`
        """
        model = GetApplicationsByIdsResult()
        if include_optional:
            return GetApplicationsByIdsResult(
                applies = [
                    avito_job.models.get_applications_by_ids_result_applies_inner.GetApplicationsByIdsResult_applies_inner(
    ...
    def testGetApplicationsByIdsResult(self):
        """Test GetApplicationsByIdsResult"""
