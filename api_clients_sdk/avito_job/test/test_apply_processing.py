...
class TestApplyProcessing(unittest.TestCase):
    """ApplyProcessing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplyProcessing:
        """Test ApplyProcessing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplyProcessing`
        """
