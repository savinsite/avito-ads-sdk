...
class TestSimplifiedVacancy(unittest.TestCase):
    """SimplifiedVacancy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimplifiedVacancy:
        """Test SimplifiedVacancy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimplifiedVacancy`
        """
        model = SimplifiedVacancy()
        if include_optional:
            return SimplifiedVacancy(
    ...
    def testSimplifiedVacancy(self):
        """Test SimplifiedVacancy"""
