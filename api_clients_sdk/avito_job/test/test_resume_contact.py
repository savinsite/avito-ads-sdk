...
class TestResumeContact(unittest.TestCase):
    """ResumeContact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResumeContact:
        """Test ResumeContact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResumeContact`
        """
        model = ResumeContact()
        if include_optional:
