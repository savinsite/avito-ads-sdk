...
class TestPaymentErrorError(unittest.TestCase):
    """PaymentErrorError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentErrorError:
        """Test PaymentErrorError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentErrorError`
        """
        model = PaymentErrorError()
        if include_optional:
            return PaymentErrorError(
                type = 'vacancies',
    ...
    def testPaymentErrorError(self):
        """Test PaymentErrorError"""
