...
class GetApplicationsByIdsResultAppliesInnerPrice(BaseModel):
    """
    Цена целевого действия (копейки)
    """ # noqa: E501
    bonus: StrictInt = Field(description="Цена целевого действия в бонусах (копейки)")
    real: StrictInt = Field(description="Цена целевого действия в реальных деньгах (копейки)")
    total: StrictInt = Field(description="Общая цена целевого действия (копейки)")
    __properties: ClassVar[List[str]] = ["bonus", "real", "total"]
