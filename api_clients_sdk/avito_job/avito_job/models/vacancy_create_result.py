...
class VacancyCreateResult(BaseModel):
    """
    VacancyCreateResult
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Идентификатор добавленной вакансии на сайте.")
    url: Optional[StrictStr] = Field(default=None, description="URL добавленной вакансии.")
    uuid: Optional[StrictStr] = Field(default=None, description="Идентификатор добавленной вакансии.")
    __properties: ClassVar[List[str]] = ["id", "url", "uuid"]
