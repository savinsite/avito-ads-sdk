...
class WebhookSubscribeRequestBody(BaseModel):
    """
    WebhookSubscribeRequestBody
    """ # noqa: E501
    secret: StrictStr = Field(description="сгенерированный ключ")
    url: StrictStr = Field(description="URL на который будут отправляться уведомления")
