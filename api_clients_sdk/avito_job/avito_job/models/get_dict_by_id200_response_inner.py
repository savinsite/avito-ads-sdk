...
class GetDictByID200ResponseInner(BaseModel):
    """
    GetDictByID200ResponseInner
    """ # noqa: E501
    deprecated: Optional[StrictBool] = Field(default=None, description="Указывает, является ли значение устаревшим. Устаревшие значения могут использоваться только при чтении ранее созданных вакансий")
    id: Optional[StrictInt] = Field(default=None, description="Уникальный идентификатор")
    name: Optional[StrictStr] = Field(default=None, description="Название")
    __properties: ClassVar[List[str]] = ["deprecated", "id", "name"]
