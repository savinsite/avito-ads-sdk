...
class VacancyStatusesResultInnerLastAction(BaseModel):
    """
    VacancyStatusesResultInnerLastAction
    """ # noqa: E501
    datetime: Optional[StrictStr] = Field(default=None, description="Время события")
    error: Optional[VacancyStatusesResultInnerLastActionError] = None
    status: Optional[StrictStr] = Field(default=None, description="Статус процесса публикации вакансии")
    __properties: ClassVar[List[str]] = ["datetime", "error", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": VacancyStatusesResultInnerLastActionError.from_dict(obj["error"]) if obj.get("error") is not None else None,
