...
class CreationForbiddenErrorError(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        ...
        if value not in set(['unavailable_to_create', 'employee_does_not_belong_to_company', 'employee_is_not_active']):
            raise ValueError("must be one of enum values ('unavailable_to_create', 'employee_does_not_belong_to_company', 'employee_is_not_active')")
        return value
