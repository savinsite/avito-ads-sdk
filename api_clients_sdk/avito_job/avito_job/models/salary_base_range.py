...
class SalaryBaseRange(BaseModel):
    """
    Размер оклада. Оклад не может превышать заработную плату. 
    """ # noqa: E501
    var_from: Optional[StrictInt] = Field(default=None, description="Нижняя граница оклада, рублей за paid_period", alias="from")
    to: Optional[StrictInt] = Field(default=None, description="Верхняя граница оклада, рублей за paid_period")
