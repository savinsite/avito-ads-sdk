...
class GetDicts200ResponseInner(BaseModel):
    """
    GetDicts200ResponseInner
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Описание категории")
    id: Optional[StrictStr] = Field(default=None, description="Уникальный идентификатор категории")
