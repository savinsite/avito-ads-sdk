...
class VacancyCreateSalaryRange(BaseModel):
    """
    Блок с вилкой зарплаты, если одновременно с salary, имеет приоритет
    """ # noqa: E501
    var_from: Optional[StrictInt] = Field(default=None, description="Нижняя граница зарплаты, рублей в месяц", alias="from")
    to: Optional[StrictInt] = Field(default=None, description="Верхняя граница зарплаты, рублей в месяц")
