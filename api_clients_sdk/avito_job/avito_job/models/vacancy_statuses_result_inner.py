...
class VacancyStatusesResultInner(BaseModel):
    """
    VacancyStatusesResultInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Идентификатор публикации вакансии в формате UUID")
    last_action: Optional[VacancyStatusesResultInnerLastAction] = None
    vacancy: Optional[VacancyStatusesResultInnerVacancy] = None
    __properties: ClassVar[List[str]] = ["id", "last_action", "vacancy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "last_action": VacancyStatusesResultInnerLastAction.from_dict(obj["last_action"]) if obj.get("last_action") is not None else None,
            "vacancy": VacancyStatusesResultInnerVacancy.from_dict(obj["vacancy"]) if obj.get("vacancy") is not None else None
        })
        return _obj
