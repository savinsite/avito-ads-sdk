...
class SearchVacancy200Response(BaseModel):
    """
    SearchVacancy200Response
    """ # noqa: E501
    meta: Optional[VacancySearchMeta] = None
    vacancies: Optional[List[SimplifiedVacancy]] = None
    __properties: ClassVar[List[str]] = ["meta", "vacancies"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.vacancies:
            for _item_vacancies in self.vacancies:
                if _item_vacancies:
                    _items.append(_item_vacancies.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": VacancySearchMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "vacancies": [SimplifiedVacancy.from_dict(_item) for _item in obj["vacancies"]] if obj.get("vacancies") is not None else None
        })
        return _obj
