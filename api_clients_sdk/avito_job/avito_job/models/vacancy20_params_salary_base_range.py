...
class Vacancy20ParamsSalaryBaseRange(BaseModel):
    """
    Блок с размером оклада. Все поля опциональны и выводятся при наличии
    """ # noqa: E501
    var_from: Optional[StrictInt] = Field(default=None, description="Нижняя граница оклада. Выводится при наличии", alias="from")
    to: Optional[StrictInt] = Field(default=None, description="Верхняя граница оклада. Выводится при наличии")
