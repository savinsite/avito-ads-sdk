...
class Vacancy20ParamsSalary(BaseModel):
    """
    Блок с вилкой зарплаты. Все поля опциональны и выводятся при наличии
    """ # noqa: E501
    var_from: Optional[StrictInt] = Field(default=None, description="Нижняя граница зарплаты. Выводится при наличии", alias="from")
    to: Optional[StrictInt] = Field(default=None, description="Верхняя граница зарплаты. Выводится при наличии")
