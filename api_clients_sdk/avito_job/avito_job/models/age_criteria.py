...
class AgeCriteria(BaseModel):
    ...
    """ # noqa: E501
    var_from: Optional[Annotated[int, Field(le=99, strict=True, ge=14)]] = Field(default=None, alias="from")
    to: Optional[Annotated[int, Field(le=99, strict=True, ge=14)]] = None
