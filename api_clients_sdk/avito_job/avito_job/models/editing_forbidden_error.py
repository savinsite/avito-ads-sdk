...
class EditingForbiddenError(BaseModel):
    """
    EditingForbiddenError
    """ # noqa: E501
    error: Optional[EditingForbiddenErrorError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": EditingForbiddenErrorError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
