...
class ItemNotFoundErrorError(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        ...
        if value not in set(['chosen_vacancy_is_not_found']):
            raise ValueError("must be one of enum values ('chosen_vacancy_is_not_found')")
        return value
