...
class Resume20ParamsEducationListInner(BaseModel):
    """
    Resume20ParamsEducationListInner
    """ # noqa: E501
    education_stop: Optional[StrictStr] = Field(default=None, description="Дата окончания учебного заведения")
    institution: Optional[StrictStr] = Field(default=None, description="Наименование учебного заведения")
    specialty: Optional[StrictStr] = Field(default=None, description="Специальность")
    __properties: ClassVar[List[str]] = ["education_stop", "institution", "specialty"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if education_stop (nullable) is None
        # and model_fields_set contains the field
        if self.education_stop is None and "education_stop" in self.model_fields_set:
            _dict['education_stop'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "education_stop": obj.get("education_stop"),
