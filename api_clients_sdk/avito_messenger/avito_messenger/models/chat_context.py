...
class ChatContext(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Тип контекста, определяет значение и смысл других полей в объекте контекста")
    value: Optional[ChatContextValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "value": ChatContextValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
