...
class PostSendMessage200Response(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[PostSendMessage200ResponseContent] = None
    created: Optional[StrictInt] = None
    direction: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["content", "created", "direction", "id", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": PostSendMessage200ResponseContent.from_dict(obj["content"]) if obj.get("content") is not None else None,
