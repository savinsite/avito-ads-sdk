...
class MessageContentCall(BaseModel):
    """
    Объект, описывающий звонок, для сообщения типа call
    """ # noqa: E501
    status: Optional[StrictStr] = None
    target_user_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["status", "target_user_id"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['missed']):
            raise ValueError("must be one of enum values ('missed')")
        return value
