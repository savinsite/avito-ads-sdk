...
class SendMessageRequestBody(BaseModel):
    ...
    """ # noqa: E501
    message: Optional[SendMessageRequestBodyMessage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "message": SendMessageRequestBodyMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
            "type": obj.get("type")
        })
        return _obj
