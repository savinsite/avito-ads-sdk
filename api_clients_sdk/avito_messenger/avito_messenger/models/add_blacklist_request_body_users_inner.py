...
class AddBlacklistRequestBodyUsersInner(BaseModel):
    """
    AddBlacklistRequestBodyUsersInner
    """ # noqa: E501
    context: Optional[AddBlacklistRequestBodyUsersInnerContext] = None
    user_id: Optional[StrictInt] = Field(default=None, description="id пользователя которого хотим заблокировать")
    __properties: ClassVar[List[str]] = ["context", "user_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "context": AddBlacklistRequestBodyUsersInnerContext.from_dict(obj["context"]) if obj.get("context") is not None else None,
