...
class MessageContentImage(BaseModel):
    ...
    """ # noqa: E501
    sizes: Optional[Dict[str, Any]] = Field(default=None, description="объект ключ-значение, где ключи - строки в формате \"ШxВ\" (ширина, высота), а значения - ссылки на изображения")
    __properties: ClassVar[List[str]] = ["sizes"]
