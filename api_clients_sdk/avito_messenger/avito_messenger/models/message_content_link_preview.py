...
class MessageContentLinkPreview(BaseModel):
    """
    MessageContentLinkPreview
    """ # noqa: E501
    description: Optional[StrictStr] = None
    domain: Optional[StrictStr] = None
    images: Optional[Dict[str, Any]] = Field(default=None, description="объект ключ-значение, где ключи - строки в формате \"ШxВ\" (ширина, высота), а значения - ссылки на изображения")
    title: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["description", "domain", "images", "title", "url"]
