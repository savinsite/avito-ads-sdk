...
class ValidatingErrorError(BaseModel):
    """
    ValidatingErrorError
    """ # noqa: E501
    code: StrictInt = Field(description="Код ошибки")
    fields: Optional[Dict[str, Any]] = Field(default=None, description="Информация об ошибке валидации параметров в формате ключ-значение")
