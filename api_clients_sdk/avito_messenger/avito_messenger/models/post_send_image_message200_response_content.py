...
class PostSendImageMessage200ResponseContent(BaseModel):
    """
    PostSendImageMessage200ResponseContent
    """ # noqa: E501
    image: Optional[PostSendImageMessage200ResponseContentImage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": PostSendImageMessage200ResponseContentImage.from_dict(obj["image"]) if obj.get("image") is not None else None
        })
        return _obj
