...
class MessageContentLocation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["kind", "lat", "lon", "text", "title"]
    ...
    def kind_validate_enum(cls, value):
        ...
        if value not in set(['house', 'street', 'area', '...']):
            raise ValueError("must be one of enum values ('house', 'street', 'area', '...')")
        return value
