...
class PostWebhookV3201Response(BaseModel):
    """
    PostWebhookV3201Response
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Уникальный идентификатор сообщения webhooks")
    payload: Optional[PayloadStruct] = None
    timestamp: Optional[StrictInt] = Field(default=None, description="Unix-timestamp времени отправки сообщения webhooks")
    version: Optional[StrictStr] = Field(default=None, description="Версия webhooks")
    __properties: ClassVar[List[str]] = ["id", "payload", "timestamp", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "payload": PayloadStruct.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
