...
class TestSendMessageRequestBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendMessageRequestBody:
        """Test SendMessageRequestBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMessageRequestBody`
        """
        model = SendMessageRequestBody()
        if include_optional:
            return SendMessageRequestBody(
                message = avito_messenger.models.send_message_request_body_message.sendMessageRequestBody_message(
                    text = '', ),
                type = 'text'
            )
        else:
    ...
    def testSendMessageRequestBody(self):
        """Test SendMessageRequestBody"""
