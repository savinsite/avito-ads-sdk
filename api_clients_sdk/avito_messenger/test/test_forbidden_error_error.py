...
class TestForbiddenErrorError(unittest.TestCase):
    """ForbiddenErrorError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForbiddenErrorError:
        """Test ForbiddenErrorError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForbiddenErrorError`
        """
        model = ForbiddenErrorError()
        if include_optional:
            return ForbiddenErrorError(
                code = 403,
                message = 'Forbidden'
            )
        else:
    ...
    def testForbiddenErrorError(self):
        """Test ForbiddenErrorError"""
