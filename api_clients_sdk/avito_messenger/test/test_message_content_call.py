...
class TestMessageContentCall(unittest.TestCase):
    """MessageContentCall unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageContentCall:
        """Test MessageContentCall
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageContentCall`
        """
        model = MessageContentCall()
        if include_optional:
    ...
    def testMessageContentCall(self):
        """Test MessageContentCall"""
