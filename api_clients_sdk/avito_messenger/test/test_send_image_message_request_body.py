...
class TestSendImageMessageRequestBody(unittest.TestCase):
    """SendImageMessageRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendImageMessageRequestBody:
        """Test SendImageMessageRequestBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendImageMessageRequestBody`
        """
        model = SendImageMessageRequestBody()
        if include_optional:
            return SendImageMessageRequestBody(
                image_id = ''
            )
        else:
            return SendImageMessageRequestBody(
    ...
    def testSendImageMessageRequestBody(self):
        """Test SendImageMessageRequestBody"""
