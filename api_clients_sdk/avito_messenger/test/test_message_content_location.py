...
class TestMessageContentLocation(unittest.TestCase):
    """MessageContentLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageContentLocation:
        """Test MessageContentLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageContentLocation`
        """
        model = MessageContentLocation()
        if include_optional:
    ...
    def testMessageContentLocation(self):
        """Test MessageContentLocation"""
