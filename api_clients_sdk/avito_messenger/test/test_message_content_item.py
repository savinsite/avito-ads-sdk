...
class TestMessageContentItem(unittest.TestCase):
    """MessageContentItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageContentItem:
        """Test MessageContentItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageContentItem`
        """
        model = MessageContentItem()
        if include_optional:
    ...
    def testMessageContentItem(self):
        """Test MessageContentItem"""
