...
class TestAddBlacklistRequestBodyUsersInner(unittest.TestCase):
    """AddBlacklistRequestBodyUsersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddBlacklistRequestBodyUsersInner:
        """Test AddBlacklistRequestBodyUsersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddBlacklistRequestBodyUsersInner`
        """
        model = AddBlacklistRequestBodyUsersInner()
        if include_optional:
            return AddBlacklistRequestBodyUsersInner(
    ...
    def testAddBlacklistRequestBodyUsersInner(self):
        """Test AddBlacklistRequestBodyUsersInner"""
