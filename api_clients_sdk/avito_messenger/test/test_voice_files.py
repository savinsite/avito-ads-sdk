...
class TestVoiceFiles(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VoiceFiles:
        """Test VoiceFiles
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoiceFiles`
        """
        model = VoiceFiles()
        if include_optional:
            return VoiceFiles(
                voices_urls = {
                    'key' : 'https://avito.ru/voice_url'
                    }
            )
        else:
            return VoiceFiles(
