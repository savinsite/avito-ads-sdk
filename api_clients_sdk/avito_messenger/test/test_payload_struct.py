...
class TestPayloadStruct(unittest.TestCase):
    """PayloadStruct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayloadStruct:
        """Test PayloadStruct
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayloadStruct`
        """
        model = PayloadStruct()
        if include_optional:
