...
class TestInfoVas(unittest.TestCase):
    """InfoVas unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InfoVas:
        """Test InfoVas
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfoVas`
        """
        model = InfoVas()
        if include_optional:
            return InfoVas(
