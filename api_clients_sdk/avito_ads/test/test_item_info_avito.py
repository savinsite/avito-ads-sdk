...
class TestItemInfoAvito(unittest.TestCase):
    """ItemInfoAvito unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemInfoAvito:
        """Test ItemInfoAvito
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemInfoAvito`
        """
        model = ItemInfoAvito()
        if include_optional:
            return ItemInfoAvito(
                autoload_item_id = '',
                ...
                url = '',
                vas = [
                    avito_ads.models.info_vas.InfoVas(
                        finish_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        schedule = [
