...
class TestCallsStatsRequest(unittest.TestCase):
    """CallsStatsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallsStatsRequest:
        """Test CallsStatsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallsStatsRequest`
        """
        model = CallsStatsRequest()
        if include_optional:
            return CallsStatsRequest(
                date_from = '',
                date_to = '',
                item_ids = [
                    56
    ...
    def testCallsStatsRequest(self):
        """Test CallsStatsRequest"""
