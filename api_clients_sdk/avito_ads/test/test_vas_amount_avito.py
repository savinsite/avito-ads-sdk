...
class TestVasAmountAvito(unittest.TestCase):
    """VasAmountAvito unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VasAmountAvito:
        """Test VasAmountAvito
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VasAmountAvito`
        """
        model = VasAmountAvito()
        if include_optional:
            return VasAmountAvito(
                amount = 1.337
            )
        else:
            return VasAmountAvito(
