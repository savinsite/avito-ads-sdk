...
class TestUpdatePriceRequest(unittest.TestCase):
    """UpdatePriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePriceRequest:
        """Test UpdatePriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePriceRequest`
        """
        model = UpdatePriceRequest()
        if include_optional:
    ...
    def testUpdatePriceRequest(self):
        """Test UpdatePriceRequest"""
