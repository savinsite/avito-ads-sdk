...
class StickerResp(BaseModel):
    """
    Информация о значках для переданного списка объявлений
    """ # noqa: E501
    description: StrictStr = Field(description="Описание значка")
    id: StrictInt = Field(description="Идентификатор значка")
    title: StrictStr = Field(description="Название значка")
