...
class ItemsInfoWithCategoryAvitoResourcesInnerCategory(BaseModel):
    """
    ItemsInfoWithCategoryAvitoResourcesInnerCategory
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Идентификатор категории")
    name: Optional[StrictStr] = Field(default=None, description="Наименование категории")
