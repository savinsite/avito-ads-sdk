...
class ItemsInfoWithCategoryAvito(BaseModel):
    """
    ItemsInfoWithCategoryAvito
    """ # noqa: E501
    meta: Optional[ItemsInfoWithCategoryAvitoMeta] = None
    resources: Optional[List[ItemsInfoWithCategoryAvitoResourcesInner]] = None
    __properties: ClassVar[List[str]] = ["meta", "resources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": ItemsInfoWithCategoryAvitoMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "resources": [ItemsInfoWithCategoryAvitoResourcesInner.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None
        })
        return _obj
