...
class StatisticsResponseResult(BaseModel):
    """
    Статистические счетчики объявления
    """ # noqa: E501
    items: Optional[List[StatisticsCountersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [StatisticsCountersInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
