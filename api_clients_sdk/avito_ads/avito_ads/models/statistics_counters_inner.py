...
class StatisticsCountersInner(BaseModel):
    """
    StatisticsCountersInner
    """ # noqa: E501
    item_id: Optional[StrictInt] = Field(default=None, description="Идентификатор объявления", alias="itemId")
    stats: Optional[List[StatisticsCountersInnerStatsInner]] = None
    __properties: ClassVar[List[str]] = ["itemId", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats": [StatisticsCountersInnerStatsInner.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
